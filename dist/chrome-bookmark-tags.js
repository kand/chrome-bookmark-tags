...
(function (bookmarks, storage) {
  ...
  var tags;
  var tags_keys;
  var refresh_tags = function refresh_tags() {
  ...
  var add_tags = function add_tags(id, tags) {
    var bookmark_info = {};
    bookmark_info[id] = tags;
    storage.sync.set(bookmark_info);
  };

  var dfs_tree_writer = (function (_dfs_tree_writer) {
    function dfs_tree_writer(_x, _x2) {
      return _dfs_tree_writer.apply(this, arguments);
    }

    dfs_tree_writer.toString = function () {
      return _dfs_tree_writer.toString();
    };

    return dfs_tree_writer;
  })(function (dom_node, root) {
    var i, child;
...
//# sourceMappingURL=chrome-bookmark-tags.js.map